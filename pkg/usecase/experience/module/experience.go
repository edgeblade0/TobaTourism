...
func (u *experience) GetExperienceByID(experienceID int64) (models.Response, error) {
...
func (u *experience) CreateExperience(description, lokasi string) (models.Response, error) {
...
func (u *experience) UpdateExperience(experienceID int64, description, lokasi string) (models.Response, error) {
...
func (u *experience) DeleteExperience(experienceID int64) (models.Response, error) {
